...
Project done during **Full Stack Software Engineering studies** at **ALX SWE**. It aims to learn about doubly linked list in **C language**.

## Technologies
* Scripts written in Bash 5.4.17(1)
